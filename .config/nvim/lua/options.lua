...
-- vim.opt.maxmem = 2000000 -- 1つのバッファに使える最大メモリ(Kbyte単位)
vim.opt.maxmempattern = 2000000 -- 検索に使える最大メモリ(Kbyte単位)
-- vim.opt.maxmemtot = 2000000 -- 全てのバッファで使用するメモリの合計の最大値 (Kbyte単位)
